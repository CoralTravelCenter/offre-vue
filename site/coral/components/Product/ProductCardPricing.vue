    ...
    <div v-else
      ...
      >
        <PopoverTrigger as-child>
          ...
          <button
              type="button"
              class="product-card-pricing__cashback cashback cashback-trigger m-0 grid w-full cursor-pointer grid-cols-[1fr_auto] rounded-lg border-0 bg-coral-cashback px-2 py-1.5 text-left text-inherit appearance-none font-inherit outline-none transition-[filter,box-shadow] duration-150 hover:brightness-[0.98] hover:shadow-sm active:brightness-[0.95] focus-visible:ring-2 focus-visible:ring-primary/45 focus-visible:ring-offset-2"
        ...
        <PopoverContent
            ...
            align="center"
            :align-offset="0"
            class="offre-vue-cashback-popover-content offre-shadow-ring w-[min(var(--reka-popover-trigger-width),calc(100vw-32px))] max-w-[calc(100vw-32px)] border-0 rounded-xl px-3 py-0"
            show-arrow
            :arrow-width="16"
            :arrow-height="8"
            arrow-rounded
            ...
            <div class="promos-grid flex flex-col text-[12px] font-semibold">
              <div
                ...
                <a v-if="promo.content_link" :href="promo.content_link"
                   class="description cursor-pointer text-right underline decoration-[1px] underline-offset-2 transition-colors duration-150 hover:text-primary active:text-primary/80 min-[768px]:max-[1279px]:min-w-0 min-[768px]:max-[1279px]:text-wrap"
              ...
              <div
                ...
                <a href="https://coralbonus.ru/registration?promo=R3R5VO93GKG8N1PGQC1UP0G6EICQLRWEN3Z64WZGC4YBYIKHFJV55IND5O20WUJ"
                   class="action cursor-pointer rounded-lg bg-primary px-3 py-1.5 text-primary-foreground transition-colors duration-150 hover:bg-primary/90 active:bg-primary/80"
