...
const props = defineProps({
  ...
  arrowWidth: { type: Number, required: false, default: 12 },
  arrowHeight: { type: Number, required: false, default: 6 },
  arrowRounded: { type: Boolean, required: false, default: false },
  arrowClass: {
...
const delegatedProps = reactiveOmit(props, "class", "showArrow", "arrowClass", "arrowWidth", "arrowHeight", "arrowRounded");
