  ...
  >
    ...
    <SelectIcon as-child>
      <ChevronDown
        ...
        class="size-4 origin-center text-foreground transition-[transform,color] duration-200 ease-out group-data-[state=open]/select-trigger:rotate-180 group-data-[state=open]/select-trigger:text-primary"
      />
    </SelectIcon>
  </SelectTrigger>
</template>
